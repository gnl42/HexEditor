...
final class SelectBlockDialog extends Dialog {
    ...
    private void createComposite1() {
        ...
        SelectionAdapter hexTextSelectionAdapter = new SelectionAdapter() {
            ...
            public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) {
                ...
                /*
                 * Crashes when the text is not a number if (lastHexButtonSelected) return; String startTextNew =
                 * startText.getText(); String endTextNew = endText.getText(); startTextNew =
                 * Integer.toHexString(Integer.parseInt(startTextNew )).toUpperCase(); endTextNew =
                 * Integer.toHexString(Integer.parseInt (endTextNew)).toUpperCase();
                 * startText.setText(startTextNew); // generate event endText.setText(endTextNew); // generate event
         ...
         * SelectionAdapter() { public void widgetSelected(org.eclipse.swt.events.SelectionEvent e) { if
         * (!lastHexButtonSelected) return; String startTextNew = startText.getText(); String endTextNew =
         * endText.getText(); startTextNew = Integer.toString(Integer.parseInt(startTextNew, 16));
         * endTextNew = Integer.toString(Integer.parseInt(endTextNew, 16)); startText.setText(startTextNew);
         * // generate event endText.setText(endTextNew); // generate event lastHexButtonSelected = false; }
         * };
         */
    ...
    public boolean open(Shell parentShell, RangeSelection rangeSelection, long aLimit) {
        ...
        label.setText(TextUtility.format(Texts.SELECTION_BLOCK_DIALOG_RANGE_LABEL, NumberUtility.getDecimalString(limit), NumberUtility.getHexString(0),
